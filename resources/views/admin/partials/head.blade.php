...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets-admin'.$dir)}}/css/select2.css">
    <link rel="stylesheet" href="{{asset('assets-admin'.$dir)}}/css/dropzone.css">
    <link rel="stylesheet" href="{{asset('assets-admin'.$dir)}}/css/uppy.min.css">
    <link rel="stylesheet" href="{{asset('assets-admin'.$dir)}}/css/jquery.steps.css">
    <link rel="stylesheet" href="{{asset('assets-admin'.$dir)}}/css/jquery.timepicker.css">
    <link rel="stylesheet" href="{{asset('assets-admin'.$dir)}}/css/quill.snow.css">
